...
const Analytics = () => {
  ...
  const handleWithdraw = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post((import.meta.env.MODE === 'development' ? (import.meta.env.MODE === 'development' ? 'http://localhost:8000' : 'https://socialhub-ai-backend.onrender.com') + '' : 'https://socialhub-ai-backend.onrender.com') + "api/v1/payment/withdraw", 
